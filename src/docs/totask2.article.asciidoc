...
Automatisierte builds mit dem build Server *jenkins* finden in der cloud auf einer openShift application statt.
Der Server holt sich den master-Branch von github und generiert Dokumentation und führt einen Testlauf durch.
