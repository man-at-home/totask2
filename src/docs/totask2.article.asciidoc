...
dazu https://travis-ci.org/[travis-ci] und https://codeship.com/[codeship] sowie https://app.shippable.com[shippable]
...
https://twitter.com/totask2tweeter[@totask2tweeter], andere Tools probiere ich gerade (Slack, HipChat).
